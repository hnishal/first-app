 ...
 return ( 
    ...
    <div class="login-box-content">
        <div class="fb-login box-shadow"><a class="d-flex flex-row align-items-center social-login-link" href="#"><i
                    ...
                    style={{marginLeft:"0px",paddingRight:"20px",paddingLeft:"22px",width:"56px"}}></i>Login with
                Facebook</a></div>
    ...
    <div class="submit-row" style={{marginBottom:"8px",paddingTop:"0px"}}><button
            class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit"  onClick={(event) =>{profileurl(event)}} >Login</button>
    ...
    /* onClick={(event) =>{profileurl(event)}} */
